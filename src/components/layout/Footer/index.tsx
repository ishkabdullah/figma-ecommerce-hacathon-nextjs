...
const socialsData: SocialNetworks[] = [
  ...
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https://www.facebook.com/ishk.abdullah?mibextid=ZbWKwL",
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "https://www.instagram.com/ishk_abdullah/profilecard/?igsh=eWd5cGJjZjg0eGhy",
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/ishkabdullah",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
              Shop.co © Made by 
              <Link
                href="https://www.linkedin.com/in/ishkabdullah22?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
